...
func newProgram(db *gorm.DB, opts ...gen.DOOption) program {
	...
	_program.Actors = field.NewString(tableName, "actors")
	_program.ActorNum = field.NewInt32(tableName, "actor_num")
...
type program struct {
	...
	Actors      field.String // 作者名
	ActorNum    field.Int32
...
func (p *program) updateTableName(table string) *program {
	...
	p.Actors = field.NewString(table, "actors")
	p.ActorNum = field.NewInt32(table, "actor_num")
...
func (p *program) fillFieldMap() {
	...
	p.fieldMap["actors"] = p.Actors
	p.fieldMap["actor_num"] = p.ActorNum
